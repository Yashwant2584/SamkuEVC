...
export const chargers = [
  ...
  },
  {
    ...
    image: ["/type 7.jpg"],
    price: "₹945 + 18% tax",
    powerOptions: ["80V","125V"],
    compatibility: ["CCS Type 2"],
    features: ["IP67 Protection", "Push-lock Mechanism", "Cable Length: 5 meter", "Compatibilty: CCS Type 2"],
    category: "EV Accessories",
    colours: []
  },
  {
