...
const FranchiseSection = () => {
  ...
  const features = {
    service: [
      { icon: <FaTools />, text: "Complete workshop setup ", desc: "Full assistance in setting up your service center" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden relative py-10 sm:py-20">
        ...
        <div className="flex justify-center mb-6 sm:mb-10">
          <div className="relative inline-flex items-center p-1 rounded-full bg-gray-100/80 backdrop-blur-sm shadow-inner">
            ...
            <button
              ...
              className={`relative z-10 px-6 sm:px-8 py-1 sm:py-2 rounded-full text-sm font-semibold transition-colors duration-300 ${
              ...
              >
                ...
                <div className="relative p-4 sm:p-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-8">
                    {features[activeType].map((feature, index) => (
                      <motion.div
                        ...
                        className="p-3 sm:p-5 rounded-xl bg-gray-50/50 border border-gray-100 hover:shadow-md transition-all duration-300"
                      >
                        ...
                        <p className="text-gray-600 text-sm sm:text-sm">{feature.desc}</p>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  <motion.button 
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={`w-full py-3 sm:py-5 rounded-xl font-semibold text-base sm:text-lg shadow-lg text-white
