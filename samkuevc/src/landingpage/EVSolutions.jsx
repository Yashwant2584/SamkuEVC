    ...
    <div className="pt-24 pb-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-20">
                  ...
                  <div className="flex items-center mb-4">
                    <div className={`w-12 h-12 rounded-full ${feature.color === 'blue' ? 'bg-blue-100' : 'bg-green-100'} flex items-center justify-center mr-4 flex-shrink-0`}>
                      <svg 
                        ...
                        className={`h-6 w-6 ${feature.color === 'blue' ? 'text-blue-600' : 'text-green-600'}`} 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
          ...
          >
            <div className="bg-gradient-to-r from-blue-800 to-green-600 p-10 rounded-2xl text-white shadow-xl max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-4">Complete Enterprise Solutions</h2>
