...
import ServiceLocationMap from '../../pages/landing-page/map';
// import ServiceCenterFinder from "../../pages/landing-page/Getlocation";
...
const LocationsSection = () => {
  ...
  const serviceLocations = [
    {
      name: "SamkuEvc Headquarters",
      latitude: 18.655866,
      longitude: 73.893685,
      address: "123 Electric Avenue, New York, NY 10001",
      description: "Our flagship service center with full diagnostic and repair facilities",
      hours: "Mon-Sat: 8AM-7PM",
      phone: "(212) 555-1234",
      markerImage: 'https://cdn-icons-png.flaticon.com/512/4614/4614840.png'
    },
    {
      name: "SamkuEvc Downtown",
      latitude: 18.623165,
      longitude: 73.915169,
      address: "456 Battery Street, New York, NY 10002",
      description: "Specialized in rapid charging solutions and quick maintenance",
      hours: "Mon-Sun: 7AM-9PM",
      phone: "(212) 555-5678",
      markerImage: "https://cdn-icons-png.flaticon.com/512/3448/3448636.png"
    },
    {
      name: "SamkuEvc Brooklyn",
      latitude: 18.565069,
      longitude: 73.978210,
      address: "789 Volt Lane, Brooklyn, NY 11201",
      description: "Full-service facility with the latest diagnostic equipment",
  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:py-16" id="locations">
      <div className="text-center mb-8 sm:mb-12">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
          Find a <span className="text-blue-600">Service Center</span> Near You
        </h2>
        <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
          Our network of service centers provides expert care for your electric vehicle. Explore our locations and find the one closest to you.
        </p>
      ...
      >
        <div className="shadow-lg rounded-xl overflow-hidden border border-gray-200">
          <ServiceLocationMap locations={serviceLocations} />
        </div>
      </motion.div>
    </div>
  );
